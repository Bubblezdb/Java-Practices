...
public class SlotMachine extends Application
{
   ...
   private final int COLS = 4;	      // Number of columns
   private final int SIZE = 11;	      // Number of Image objects
   ...
   public void start(Stage primaryStage)
   {
      ...
      HBox slotImagesHBox = new HBox(11, slotImages[0], slotImages[1], slotImages[2], slotImages[3]);
      
      // Create the controls for the amount inserted.
      Label insertedPrompt = new Label("Amount Inserted: $");
      insertedTextField = new TextField();
      HBox insertedHBox = new HBox(11, insertedPrompt, insertedTextField);
      ...
      HBox wonThisSpinHBox = new HBox(11, wonThisSpinDescriptor, wonThisSpinOutputLabel);
      ...
      HBox totalWonHBox = new HBox(11, totalWonDescriptor, totalWonOutputLabel);
      ...
      VBox mainVBox = new VBox(11, slotImagesHBox, insertedHBox,
                                   wonThisSpinHBox, totalWonHBox,
                                   spinButton, displayInfoLabel);
      mainVBox.setAlignment(Pos.CENTER);
      mainVBox.setPadding(new Insets(11));
   ...
   {  
      ...
      if (slotMemory[0] == slotMemory[1] && 
          ...
          slotMemory[0] == slotMemory[3])
      {
         // If three of the images match, the user has won 
         // three times the amount entered.
         amountWon = amountBet * FOUR;
         
         // Display the instructions.
         displayInfoLabel.setText("Jackpot! FOUR of a KIND WIN x 4!!"); 
	  }
		// Determine the winnings.
          ...
          slotMemory[0] == slotMemory[2])
      {
         ...
         displayInfoLabel.setText("Jackpot! TRIPLE WIN x 3!!");       
               ...
               slotMemory[0] == slotMemory[2] ||
			   slotMemory[0] == slotMemory[3] ||
			   slotMemory[1] == slotMemory[3] ||
			   slotMemory[2] == slotMemory[3] ||
